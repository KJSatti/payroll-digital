            ...
            <form method="POST" action="{{ route('salaries.store') }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="bonuses" step="0.01" value="0"
                            class="w-full border px-3 py-2 rounded">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="overtime_pay" step="0.01" value="0"
                            class="w-full border px-3 py-2 rounded">
                    </div>

                    <div>
                        <label class="block mb-1">Pay Period</label>
                        <input type="text" name="pay_period" required class="w-full border px-3 py-2 rounded">
                    </div>

                    <div>
                        <label class="block mb-1">Pay Date</label>
                        <input type="date" name="pay_date" required class="w-full border px-3 py-2 rounded">
                    </div>
                </div>
